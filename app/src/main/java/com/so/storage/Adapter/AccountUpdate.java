...
public class AccountUpdate extends AsyncTask<Void, Void, Void> {
    MemberUserDTO dto;
    ...
    public AccountUpdate(MemberUserDTO dto) {
        this.dto = dto;
    }
    ...
    protected Void doInBackground(Void... voids) {
        ...
        //Url 만들기
        String postURL = ipconfig + project_path + "/and_accountUpdate";
